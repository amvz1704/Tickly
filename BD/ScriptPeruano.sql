...
ALTER TABLE public."Admim" ADD CONSTRAINT "Usuario_fk"
FOREIGN KEY ("id_usuario_Usuario")
REFERENCES public."Usuario" (id_usuario)
MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE public."Admim" ADD CONSTRAINT "Admim_uq"
UNIQUE ("id_usuario_Usuario");
...
-- ============================================================
-- Tabla: many_Local_has_many_Evento (relación N:N)
-- ============================================================
...
-- Relaciones Venta/Ticket/Eventos/Zonas
